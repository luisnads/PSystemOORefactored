...
public abstract class Employee {
    ...
    public abstract void setSell(ArrayList<Employee> employees, int id);
    public abstract void setCard(ArrayList<Employee> employees, int id);
    public abstract Employee toPay(Employee employee, double forPay);
